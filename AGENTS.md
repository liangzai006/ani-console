...
This project is indexed by GitNexus as **ani-console** (2371 symbols, 6581 relationships, 186 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
