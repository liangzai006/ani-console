...
This project is indexed by GitNexus as **ani-console** (2009 symbols, 4808 relationships, 162 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
