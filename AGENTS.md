...
This project is indexed by GitNexus as **ani-console** (2326 symbols, 6471 relationships, 183 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
