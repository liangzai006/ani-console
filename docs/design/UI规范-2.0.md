...
| 工程实现 | `ANI-11-代码实现规范.md` §六、`docs/CONVENTIONS.md` | 路由结构、API Client、状态管理、**页面文件组织** |
...
| 6 | [CONSOLE-SPEC-COMPLIANCE-BATCHES.md](../CONSOLE-SPEC-COMPLIANCE-BATCHES.md) | **规范落地批次** SCB-01～12（冻结后按序改页面） |
| 7 | [DESIGN-SPEC-FREEZE.md](./DESIGN-SPEC-FREEZE.md) | 设计规范 2.0 **冻结令** |
| 8 | [CONVENTIONS.md](../CONVENTIONS.md) | Console **工程**约定 |
| 9 | [CONSOLE-TASK-PLAN.md](../CONSOLE-TASK-PLAN.md) | Console **任务计划** |
...
3. 对照仓库根目录下的现有页面与 `demo-instance-workspace-ui-a` 参考实现
...
> **🔒 本文档集已冻结（2026-06-25）**，本节仅作历史说明；**不得再编辑**。维护 [DESIGN-SPEC-FREEZE.md](./DESIGN-SPEC-FREEZE.md) 与 [CONSOLE-SPEC-COMPLIANCE-BATCHES.md](../CONSOLE-SPEC-COMPLIANCE-BATCHES.md) 追踪落地进度。

- 产品视觉与交互变更：须发起 **3.0 / 修订版** 新文档，不得直接改 2.0 正文。
- Arco 大版本升级：在工程层适配，规范正文冻结不变。
- 落地进度：写入 `docs/CONSOLE-TASK-PLAN.md`，不写入本规范。
