...
export interface components {
  schemas: {
    ...
    VolumeOSInitGuide: {
      status: string;
      device: string;
      steps: components["schemas"]["VolumeOSInitStep"][];
      hint: string;
    };
...
export interface operations {
  ...
  getNetworkSecurityGroupRule: {
    parameters: {
      query?: never;
      header?: never;
      path: { security_group_id: string; rule_id: string };
      cookie?: never;
    };
    requestBody?: never;
    responses: {
  ...
  completeVolumeOSInit: {
    ...
    responses: {
      200: {
        headers: { [name: string]: unknown };
        content: { "application/json": components["schemas"]["StorageVolume"] };
      };
      400: components["responses"]["BadRequest"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
  ...
  createFilesystemMountTarget: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["CreateFilesystemMountTargetRequest"];
      };
    };
    responses: {
